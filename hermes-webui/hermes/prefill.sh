...
6. Call `post_trade_setup` with direction (long/short), entry, sl, tp1 (mandatory), tp2/tp3 (optional), and a rationale sentence. Levels appear on the chart as a trade card.
---
MSG
