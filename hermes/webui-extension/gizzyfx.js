 ...
 *
 * Registers THREE switchable skins in Settings → Appearance:
...
(function () {
  ...
  /* ── 1. Seed GizzyFx Cyan as the default skin, once ──────────────── */
  ...
  /* ── 2. Register all three GizzyFx skins ─────────────────────────── */
  ...
  function getMarkSvg() {
    var skin = document.documentElement.dataset.skin || "gizzyfx";
    return MARK_SVGS[skin] || MARK_SVGS["gizzyfx"];
  }
